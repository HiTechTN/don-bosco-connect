        ...
        <>
          {user.role === 'admin' && (
            <>
              ...
              <Stack.Screen name="Profile" component={ProfileScreen} options={{ headerShown: true, title: 'Profil', headerTintColor: '#4F46E5' }} />
            </>
          )}
          {user.role === 'teacher' && (
            <>
              ...
              <Stack.Screen name="Profile" component={ProfileScreen} options={{ headerShown: true, title: 'Profil', headerTintColor: '#059669' }} />
            </>
          )}
          {user.role === 'student' && (
            <>
              ...
              <Stack.Screen name="Profile" component={ProfileScreen} options={{ headerShown: true, title: 'Profil', headerTintColor: '#D97706' }} />
            </>
          )}
          {user.role === 'parent' && (
            <>
              ...
              <Stack.Screen name="Messages" component={MessagesScreen} options={{ headerShown: true, title: 'Messages', headerTintColor: '#8B5CF6' }} />
              <Stack.Screen name="Profile" component={ProfileScreen} options={{ headerShown: true, title: 'Profil', headerTintColor: '#DC2626' }} />
            </>
          )}
          {sharedScreens}
        </>
