...
- Name: public-portal-ar.spec.ts >> MentionsLegalesPage — Arabic rendering >> shows Arabic page title
- Location: tests/public-portal-ar.spec.ts:207:3
...
Locator: locator('h1')
Expected substring: "الإشعارات القانونية"
Received string:    "legal.title"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    14 × locator resolved to <h1 class="text-3xl md:text-4xl font-bold text-white">legal.title</h1>
       - unexpected value "legal.title"
