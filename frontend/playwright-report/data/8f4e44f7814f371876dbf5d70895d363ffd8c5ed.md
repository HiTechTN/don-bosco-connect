...
- Name: public-portal-ar.spec.ts >> AnnounceDetailPage — Arabic rendering >> shows Arabic reactions section
- Location: tests/public-portal-ar.spec.ts:178:3
...
Locator: locator('text=ردود الفعل')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=ردود الفعل')
