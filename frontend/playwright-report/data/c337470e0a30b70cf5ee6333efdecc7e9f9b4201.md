...
- Name: public-portal-ar.spec.ts >> PolitiqueRGPDPage — Arabic rendering >> shows Arabic subtitle
- Location: tests/public-portal-ar.spec.ts:252:3
...
Locator: locator('text=متوافق مع RGPD').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=متوافق مع RGPD').first()
