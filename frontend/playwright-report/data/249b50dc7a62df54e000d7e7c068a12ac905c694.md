...
- Name: public-portal-ar.spec.ts >> PolitiqueRGPDPage — Arabic rendering >> shows Arabic minors section
- Location: tests/public-portal-ar.spec.ts:274:3
...
Locator: locator('text=حماية القاصرين')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=حماية القاصرين')
