...
- Name: public-portal-ar.spec.ts >> MentionsLegalesPage — Arabic rendering >> shows Arabic section headings
- Location: tests/public-portal-ar.spec.ts:212:3
...
Locator: locator('text=ناشر الموقع')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=ناشر الموقع')
