...
- Name: public-portal-ar.spec.ts >> AnnouncesPage — Arabic rendering >> renders with RTL direction
- Location: tests/public-portal-ar.spec.ts:125:3
...
- main:
  ...
  - paragraph: announces.desc
  - img
  - textbox "announces.search_placeholder"
  - button "announces.cat_all"
  - button "announces.cat_general"
  - button "announces.cat_evenement"
  - button "announces.cat_academique"
  - button "announces.cat_pedagogique"
  - button "announces.cat_vie_scolaire"
  - img
  - paragraph: announces.no_results
  - paragraph: announces.no_results_desc
- contentinfo:
  - img
  - text: Don Bosco Connect
