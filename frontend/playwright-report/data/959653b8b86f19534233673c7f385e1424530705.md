...
- Name: public-portal-ar.spec.ts >> ContactPage — Arabic rendering >> shows Arabic contact info
- Location: tests/public-portal-ar.spec.ts:300:3
...
Locator: locator('text=معلومات الاتصال')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=معلومات الاتصال')
