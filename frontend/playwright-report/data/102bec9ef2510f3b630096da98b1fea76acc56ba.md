...
- Name: public-portal-ar.spec.ts >> AnnouncesPage — Arabic rendering >> shows Arabic search placeholder
- Location: tests/public-portal-ar.spec.ts:145:3
...
Locator: locator('input[placeholder="البحث عن إعلان..."]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder="البحث عن إعلان..."]')
