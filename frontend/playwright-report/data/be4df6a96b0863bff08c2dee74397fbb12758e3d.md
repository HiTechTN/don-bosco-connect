...
- Name: public-portal-ar.spec.ts >> AnnouncesPage — Arabic rendering >> shows Arabic category filters
- Location: tests/public-portal-ar.spec.ts:136:3
...
Locator: locator('button').filter({ hasText: 'الكل' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button').filter({ hasText: 'الكل' })
