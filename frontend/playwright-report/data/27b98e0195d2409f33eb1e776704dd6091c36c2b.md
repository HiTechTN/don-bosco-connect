...
- Name: public-portal-ar.spec.ts >> AnnounceDetailPage — Arabic rendering >> shows Arabic back link
- Location: tests/public-portal-ar.spec.ts:168:3
...
Locator: locator('text=العودة إلى الإعلانات')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=العودة إلى الإعلانات')
