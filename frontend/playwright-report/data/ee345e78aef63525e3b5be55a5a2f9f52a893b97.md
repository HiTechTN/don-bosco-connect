...
- Name: public-portal-ar.spec.ts >> PolitiqueRGPDPage — Arabic rendering >> shows Arabic data categories
- Location: tests/public-portal-ar.spec.ts:257:3
...
Locator: locator('text=البيانات المجمعة')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=البيانات المجمعة')
