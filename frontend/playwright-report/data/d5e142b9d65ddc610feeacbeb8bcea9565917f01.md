...
- Name: public-portal-ar.spec.ts >> PolitiqueRGPDPage — Arabic rendering >> shows Arabic security section
- Location: tests/public-portal-ar.spec.ts:269:3
...
Locator: locator('text=تدابير الأمان')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=تدابير الأمان')
