...
- Name: public-portal-ar.spec.ts >> MentionsLegalesPage — Arabic rendering >> shows Arabic back link
- Location: tests/public-portal-ar.spec.ts:220:3
...
Locator: locator('text=العودة إلى الصفحة الرئيسية')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=العودة إلى الصفحة الرئيسية')
