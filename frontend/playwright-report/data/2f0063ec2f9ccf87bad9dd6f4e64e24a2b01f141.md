...
- Name: public-portal-ar.spec.ts >> AnnounceDetailPage — Arabic rendering >> shows Arabic 404 for missing announcement
- Location: tests/public-portal-ar.spec.ts:183:3
...
Locator: locator('text=لم يتم العثور على الإعلان')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=لم يتم العثور على الإعلان')
