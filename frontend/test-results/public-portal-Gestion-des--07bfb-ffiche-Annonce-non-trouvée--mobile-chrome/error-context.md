...
- Name: public-portal.spec.ts >> Gestion des erreurs >> page d'annonce inexistante affiche "Annonce non trouvée"
- Location: tests/public-portal.spec.ts:315:3
...
Locator: locator('text=Annonce non trouvée')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Annonce non trouvée')
