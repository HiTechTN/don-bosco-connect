...
- Name: public-portal.spec.ts >> Page d'accueil >> clique sur "Voir toutes les annonces" et navigue vers /annonces
- Location: tests/public-portal.spec.ts:125:3
...
Call log:
  - waiting for locator('a').filter({ hasText: 'Voir toutes les annonces' }).first()
    - locator resolved to <a href="/annonces" class="hidden sm:inline-flex items-center gap-2 text-[#1B4F72] hover:text-[#F39C12] font-semibold transition-colors">…</a>
